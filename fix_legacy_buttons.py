#!/usr/bin/env python3
"""Fix button types in legacy src/src directory."""
import re
...
def main():
    base_dir = Path("C:/Users/Ravi/Downloads/LDO-2-local/src/src")

    if not base_dir.exists():
        print(f"Legacy src directory not found at {base_dir}")
        return
